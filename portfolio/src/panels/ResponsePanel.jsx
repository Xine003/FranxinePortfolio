...
import { BlogsPanel, BlogDetailPanel } from "./panels/BlogPanels";
import { CvPanel, CertificatesPanel } from "./panels/FilesPanels";
import { SocialsPanel, ContactPanel } from "./panels/ConnectPanels";
...
export default function ResponsePanel({ activeKey, sent, onDrill }) {
  ...
  const render = () => {
    ...
    if (activeKey === "projects")     return <ProjectsPanel onDrill={onDrill} />;
